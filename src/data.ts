...
export const blogs = [
  ...
  },
  {
    ...
    authors: ["Hawau Olamide Toyin", "Mutiah Apampa", "Toluwani Aremu", "Humaid Alblooshi", "Ana Rita Valente", "Gonçalo Leal", "Zhengjun Yue", "and others"],
    venue: "arXiv",
    year: 2026,
  },
  {
    ...
    link: "https://openreview.net/pdf?id=pdIPR5TSXy",
    authors: ["Samar Fares", "Toluwani Aremu", "Klea Ziu", "Nikita Durasov", "Martin Takáč", "Pascal Fua", "Karthik Nandakumar", "Ivan Laptev"],
    venue: "CVPR (AdvML)",
    year: 2026,
  },
  {
  ...
  },
  {
    ...
    authors: ["Ashmal Vayani", "Dinura Dissanayake", "Hasindri Watawana", "...", "Toluwani Aremu", "et al."],
